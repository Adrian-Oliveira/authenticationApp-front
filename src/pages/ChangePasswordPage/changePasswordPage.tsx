        ...
        <div className="changePassword__edit">
          <div className="changePassword__edit__textInputs">
            <label className="changePassword__edit__input">
              <div className="changePassword__edit__inputName">
                New Password
              </div>
              <input
              ...
              >
                Your new password need to have at least 10 characters
              </p>
            </label>
            ...
            <label className="changePassword__edit__input">
              ...
              >
                The new password and the confirmation need to be equal
              </p>
            </label>
            ...
            <button
              ...
              onClick={() =>
                updatePassword.mutate({
                  ...
                  repeatNewPassword: repeatNewPssWrd,
                })
              }
            >
              Change Password
