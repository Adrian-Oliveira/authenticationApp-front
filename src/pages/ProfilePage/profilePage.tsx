        ...
        <div className="profilePage__profile">
          <div className="profilePage__profile__header">
            <div className="profilePage__profile__header__text">
              <h2 className="profilePage__profile__header__title">Profile</h2>
          ...
          <div className="profilePage__profile__item">
            ...
            <img
              ...
              alt=""
              className="image"
              src={data.base64Photo}
              style={{ width: "7.2rem", height: "7.2rem" }}
            />
          </div>
          <div className="profilePage__profile__item">
            <div className="label">NAME</div>
            <p data-test-id="profile-name" className="data">
              {data.name ? data.name : ""}
            </p>
          </div>
          <div className="profilePage__profile__item">
            <div className="label">BIO</div>
            <p data-test-id="profile-bio" className="data">
              {data.bio}
            </p>
          </div>
          <div className="profilePage__profile__item">
            <div className="label">PHONE</div>
            <p data-test-id="profile-phone" className="data">
              {data.phone}
            </p>
          </div>
          <div className="profilePage__profile__item">
            <div className="label">EMAIL</div>
            <p data-test-id="profile-email" className="data">
              {data.email}
            </p>
          </div>
          <div className="profilePage__profile__item">
            <div className="label">CREATED AT</div>
            <p data-test-id="profile-createAt" className="data">
