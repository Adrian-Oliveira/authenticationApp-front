...
export const Step2 = () => {
  ...
  const changePassword = useMutation({
    mutationFn: (user: {
      ...
      api.postNewPasswordWithEmailToken(
        user.token,
        user.newPassword,
  ...
  return (
    <>
      <label className="resetPasswordPage__resetPasswordContainer__email">
        <i className="material-symbols-outlined">token</i>
        <input
          type="password"
          name=""
          id="resetPasswordPage__resetPasswordContainer__code"
      ...
      <button
        ...
        onClick={() =>
          changePassword.mutate({ token, newPassword, confirmNewPassword })
        }
      >
        Change the password
      </button>
