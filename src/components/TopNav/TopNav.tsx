...
const TopNav = () => {
  ...
  return (
    <div data-test-id="profile-navbar" className="topNav">
      ...
      <div className="topNav__menu" ref={menuRef}>
        <div className="topNav__profile">
          <img
            ...
            alt=""
            className="topNav__profile__image"
        ...
        <div
          className={`topNav__popup topNav__popup--${openPopup ? "active" : "inactive"}`}
          ref={popupRef}
        >
          ...
          <button
            className="topNav__popup__button"
          ...
          <button
            className="topNav__popup__button"
            onClick={() => navigate("/registerTwoFA")}
          >
          ...
          <button
            className="topNav__popup__button topNav__popup__button--logout"
